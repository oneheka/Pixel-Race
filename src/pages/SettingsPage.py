...
class SettingsPage:
    ...
    def render(self, clicked):
        ...
        toggle_on = self.game.screen.blit(self.game.util.settings[3], ((194, 257)))
        ...
        if toggle_on.collidepoint(mouse) and clicked:
            if(self.isPlaying != False):
                self.isPlaying == False
                self.game.screen.blit(self.game.util.settings[4], ((194, 257)))
